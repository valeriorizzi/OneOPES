...
#for 20 ns simulation
mpirun -n 8 gmx_mpi mdrun -s topol2.tpr -plumed plumed.dat -pin on -pinoffset 1 -nsteps 10000000 -multidir 0 1 2 3 4 5 6 7 -hrex -replex 10000 &
